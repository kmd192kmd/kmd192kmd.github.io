"""
포트폴리오(김민도)_v6.pptx - 박지명 스타일 기반 프리미엄 디자인 (v6)
Design: "Park Ji-myung Layout & Modern Premium Accents"
- 순서: Gold Market → Jesiyo → DeveryTime → 교육센터 (index.html 노출 최신 순서)
- 레이아웃: 상단 헤더 배너 + 좌측 5탭 세로 네비게이션 사이드바
...
def add_header_banner(slide, project_label, accent_color):
    ...
    rect(slide, 0, 0, 0.15, 0.85, accent_color)
...
def divider(part_num, title, subtitle, accent, accent_lite, pills_list=None):
    ...
    # Split vertical divider accent strip
...
# ══════════════════════════════════════════════════════════════════
# SAVE PRESENTATION (Version 6 - Clean Built from original sources)
# ══════════════════════════════════════════════════════════════════
out_path = r"C:\Users\a\Desktop\쇼핑몰 프로젝트 자료모음\6_자소서, 포폴 1차 완성본_260525\포트폴리오(김민도)_v6.pptx"
prs.save(out_path)
